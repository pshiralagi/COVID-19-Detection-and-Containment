...
BG_ERROR_ENUM(bg_err_radio, "Radio error.")\
BG_ERROR_ENUM(bg_err_mesh_no_data_available, "Data not available.")\
BG_ERROR_ENUM(bg_err_invalid_module_action, "Invalid module action.")\
