...
// This can be removed as this is being replaced.
/*******************************************************************************
...
//          DI_Print(buf, DI_ROW_STATUS);
          displayPrintf(DISPLAY_ROW_NAME, "%s",buf);
        }
    ...
    case gecko_evt_mesh_node_initialized_id:
      ...
      displayPrintf(DISPLAY_ROW_ACTION,"Node initialized");
...
//        DI_Print("unprovisioned", DI_ROW_STATUS);
        displayPrintf(DISPLAY_ROW_ACTION,"%s","unprovisioned");
...
//      DI_Print("provisioning...", DI_ROW_STATUS);
      displayPrintf(DISPLAY_ROW_ACTION,"%s","provisioning....");
...
//      DI_Print("provisioned", DI_ROW_STATUS);
      displayPrintf(DISPLAY_ROW_ACTION,"%s","provisioned");
      break;
